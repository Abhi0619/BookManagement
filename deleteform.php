          ...
          <nav class="navbar navbar-dark  navbar-expand-md" style="background-color: #004d80;">
           ...
           <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">   
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="http://localhost/bookmanagement/deleteform.php">Delete Book Records</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="http://localhost/bookmanagement/updateform.php">Update Book Records</a>
                </li>
              </ul>
           </div>
          </nav>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Deletion Records</li>
                </ol>
              </div>
            </div>
          </div>
...
<table border="2px" bgcolor="pink" width="400x">
<tr>
    <th>book id</th>
	<th>title</th>
	<th>price</th>
