   ...
   <header>
          ...
          <nav class="navbar navbar-dark  navbar-expand-md" style="background-color: #004d80;">
           ...
           <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">   
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="http://localhost/bookmanagement/forminsert.php">Insert Book</a>
                </li> 
	...
	<section class="breadcrumbs-section">
          <div class="container pl-3 pr-3 p-sm-3">
            <div class="row">
              <div class="col-12">
                <h2>Insertion Records</h2>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="home.html">Home</a></li>
                  <li class="breadcrumb-item active">Insertion Records</li>
                </ol>
              </div>
            </div>
          </div>
